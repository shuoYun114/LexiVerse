...
> [!NOTE]
> 🌐 **在线 GitHub Pages Demo 体验地址**: [https://shuoyun114.github.io/LexiVerse/](https://shuoyun114.github.io/LexiVerse/)  
> *(注：GitHub Pages 静态托管线为 **3D Demo 体验版**，出于安全保护不开放新账号注册；在本地/局域网部署运行将解锁完整账号注册、登录及多设备局域网自动同步功能)*
...
### 🔐 6. 账号系统与局域网多设备自动同步
- 在本地/局域网服务运行应用时，支持用户注册与登录。不同设备（如手机与电脑）访问同一个局域网地址并登录同一账号后，数据全自动无感同步！

### 📚 7. 丰富的内置词库、K-12 教材与 JSON 导入
- **🎓 全量国内初高中主流教材**：
  - **北师大版 (BNU) 初中全套**：七年级上/下册(7A/7B)、八年级上/下册(8A/8B)、九年级全一册。
  - **人教版 (PEP) 初中全套**：七年级上/下册(7A/7B)、八年级上/下册(8A/8B)、九年级全一册。
  - **高中必修系列**：人教版必修一/二、北师大版必修一、外研版必修一。
- **🎯 升学与权威考试冲刺库**：全国中考核心词库、全国高考冲刺词库、考研英语一/二词库、CET-4/6、IELTS 雅思、程序员专业词库及 🇪🇸 西班牙语入门库（原生颤音弹舌）。
- **✍️ 自建与 JSON 离线导入**：支持可视化表单录入、批量文本粘贴解析及外部 JSON 词库上传。

---

## 🌟 最新更新日志 (Latest Updates)

### ⚡ 2026年08月最新版本更新
1. **🏫 国内初中/高中全套英语教材入驻**：
   - 补齐北师大版 (BNU) 及人教版 (PEP) 初中七年级上/下 (7A/7B)、八年级上/下 (8A/8B) 及九年级全一册全套教科书！
   - 加入全国中考高频词、高考冲刺词及考研英语学术阅读词库。
2. **🎮 赛博打字速记游戏速度优化与难度调节**：
   - 解决单词掉落过快问题，加入 **🐢 轻松休闲 (调慢 65%)**、**🏃 标准挑战**、**⚡ 极限竞速** 三档速度模式。
3. **🇪🇸 西班牙语发音引擎优化**：
   - 调起浏览器原生 `es-ES` / `es-MX` 语音，支持标准地道西班牙语发音与颤音弹舌（Trill R）。
4. **✍️ 自建/导入词库交互升级**：
   - 顶栏加入 `➕ 自建/导入词库` 高亮按钮，内置 `🏫 初高中/官方教材专区` 分页，支持一键切换与自定义扩展。
