...
export const CustomBookModal: React.FC<CustomBookModalProps> = ({
  ...
  const presetBooksList = [
    ...
    },
    {
      ...
      color: '#34d399',
      items: [
        { id: 'bnu_junior_7a', name: '北师大版 初中英语七年级上册', tags: '初中基础', desc: '北师大版 BNU 初一英语上册词汇与自我介绍' },
        { id: 'bnu_junior_7b', name: '北师大版 初中英语七年级下册', tags: '初中基础', desc: '北师大版 BNU 初一英语下册社区与节日庆祝' },
        { id: 'bnu_junior_8a', name: '北师大版 初中英语八年级上册', tags: '初中进阶', desc: '北师大版 BNU 初二英语上册户外冒险与科技词汇' },
        { id: 'bnu_junior_8b', name: '北师大版 初中英语八年级下册', tags: '初中进阶', desc: '北师大版 BNU 初二英语下册跨文化交流与贡献' },
        { id: 'bnu_junior_9', name: '北师大版 初中英语九年级全一册', tags: '中考冲刺', desc: '北师大版 BNU 初三全一册成就与灵感考点' },
        { id: 'pep_junior_7a', name: '人教版 初中英语七年级上册', tags: '初中基础', desc: '人教版 PEP 初一英语上册词汇与日常习惯' },
        { id: 'pep_junior_7b', name: '人教版 初中英语七年级下册', tags: '初中基础', desc: '人教版 PEP 初一英语下册音乐与作息表达' },
        { id: 'pep_junior_8a', name: '人教版 初中英语八年级上册', tags: '初中进阶', desc: '人教版 PEP 初二英语上册词汇与拓展表达' },
        { id: 'pep_junior_8b', name: '人教版 初中英语八年级下册', tags: '初中进阶', desc: '人教版 PEP 初二英语下册日常健康与志愿者' },
